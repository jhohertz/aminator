...
"""
aminator.plugins.blockdevice.disk
==================================
basic disk block device manager
"""
import fcntl
import os
import logging
...
__all__ = ('DiskBlockDevicePlugin',)
log = logging.getLogger(__name__)


BlockDevice = namedtuple('BlockDevice', 'node handle rootdev')


class DiskBlockDevicePlugin(BaseBlockDevicePlugin):
    _name = 'disk'

    def configure(self, config, parser):
        super(DiskBlockDevicePlugin, self).configure(config, parser)
